          ...
          <Box sx={{ flexGrow: 0 }}>
            <Tooltip title="Login/LogOut">
              <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                <Avatar alt="" src="https://media.istockphoto.com/photos/sea-otter-on-ice-enhydra-lutris-prince-william-sound-alaska-in-front-picture-id1283550298?b=1&k=20&m=1283550298&s=170667a&w=0&h=ri6Mksaesf8fs4rcAQArPoG_m8YEu78piNHjVMBc3jI=" />
              </IconButton>
            </Tooltip>
            <Menu
              sx={{ mt: '45px' }}
